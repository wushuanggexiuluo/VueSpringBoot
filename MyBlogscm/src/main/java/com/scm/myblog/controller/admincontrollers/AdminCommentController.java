...
public class AdminCommentController {
    ...
    public Result getCommentPage(@RequestBody @Validated @ApiParam("评论dto对象") PageDto<CommentDto, CommentSearchDto> pto){
    ...
    public Result updateComment(@RequestBody @Validated CommentDto dto){
