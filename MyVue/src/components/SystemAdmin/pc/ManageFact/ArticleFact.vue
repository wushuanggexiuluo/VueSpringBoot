<template>
  <div class="pageDataCls">
    <div>
      ...
      <!--      <el-form :inline="true" class="demo-form-inline">-->
      <!--        <el-form-item label="搜标签">-->
      <!--          <el-input v-model="search.tag" placeholder="随便输入"></el-input>-->
      <!--        </el-form-item>-->
      <!--        <el-form-item>-->
      <!--          <el-button type="primary" @click="onSubmit">查询</el-button>-->
      <!--        </el-form-item>-->
      ...
      <el-form style="margin: 10px auto " label-width="80px" :model="addForm">
        ...
        <div style="display: flex;align-items: center;justify-content: space-between">
          <el-form-item style="background-color: wheat;height: 200px;" label="文章便签">
            <ArticleTags style="width: 950px; min-width: 950px;" :isEdit="true"
                         :categoryContent="addForm.category"></ArticleTags>
          </el-form-item>
          <img alt="NULL" style="width: 148px;height: 148px;" :src=addForm.articleThImg>
          <el-upload
              action=""
    ...
    <el-dialog
      ...
      <el-form label-width="80px" :model="updateForm">
        ...
        <div style="display: flex;align-items: center;    flex-direction: column;justify-content: space-between">
          ...
          <el-form-item style="background-color: wheat;height: 200px;" label="文章标签">

            <ArticleTags style="width: 950px; min-width: 950px;" :isEdit="true" :getNewTag="getNewTag"
...
<script>
import MyMarkDown from "@/components/SystemAdmin/pc/MyMarkDown";
import ArticleTags from "@/components/SystemAdmin/pc/ManageFact/ArticleTags";
