...
.title1 {
  ...
  background-image: linear-gradient(314deg, #30cfd0 90%, #330867 90%);
  width: 100%;
  height: 8vh;
  border-radius: 7px;
...
.articles {
  ...
  width:100%;
  background-image: linear-gradient(316deg, #7028e4 10%, #e5b2ca 10%);
  /*回去都会延时*/
  transition: all 0.8s;
}
.articles:hover{
