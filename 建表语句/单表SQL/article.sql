...
(
    article_id            int auto_increment comment '文章ID'
        primary key,
    article_user_id       int unsigned               null comment '用户ID',
    article_title         varchar(255)               not null comment '标题',
    article_content       mediumtext charset utf8mb4 not null comment '内容',
    article_view_count    int default 0              null comment '访问量',
    article_comment_count int default 0              null comment '评论数',
    article_dianzan_count int default 0              null comment '点赞数',
    article_update_time   datetime                   null comment '更新时间',
    article_create_time   datetime                   null comment '创建时间',
    article_summary       text                       null comment '摘要',
    article_th_img        varchar(255)               null comment '缩略图'
)
    charset = utf8mb3
    row_format = DYNAMIC;

INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1314, 1, '想玩转Java，那这篇内容不能错过', 'Java是最常见的后端开发语言之一，Java语言由于自身具备构建多线程的能力，且体系结构比较中立。所以在大型互联网平台的开发中得到了广泛的采用
若想玩转Java这些技术就必须掌握。
1、Java并发编程
...
6、Redis
Redis是如今互联网技术架构中，使用最广泛的缓存。支持复杂的数据结构，支持持久化，支持主从集群，支持高可用，支持较大的value存储。同时， Redis也是中高级后端工程师技术面试中，面试官最喜欢问的问题之一。特别是那些优秀的、竞争激烈的大型互联网公司（比如 Twitter、新浪微博、阿里云、腾讯云、淘宝、知乎等），通常要求面试者不仅仅掌握 Redis基础使用，更要求深层理解Redis内部实现的细节原理。毫不夸张地说，能把Redis的知识点全部吃透，你的半只脚就已经踏进心仪大公司的技术研发部。', 1128, 6, 14, '2023-05-06 14:01:18', '2022-11-11 11:43:10', '若想玩转Java这些技术就必须掌握。', 'http://cdn.forevergtt.love/mysystem/medicine/e2fc57a6-9201-4a12-a4c1-331a61897d90@th7');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1315, 2, '量子力学？量子计算机？秒杀传统计算机的能力从何而来？', '.:
...
', 1021, 0, 4, '2023-05-06 14:01:18', '2022-11-02 11:43:16', '今年，“量子力学”成为一个非常热门的话题，那么，量子力学是什么呢？', 'http://cdn.forevergtt.love/mysystem/medicine/f1b7b960-f153-4a94-be39-b7e282651642');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1316, 3, '就业岗位只增不减！Java语言还能火多久？', '有句俗话经常说：男怕入错行，女怕嫁错郎。
...
对于已入行的从业者来说，抓住时机，不断更新自己的技术，提高能力是重点。而对于那些打算入行的观望者来说，尽快入行，并且深入学习行业知识是通往成功的主要途径。', 96, 5, 4, '2023-05-06 14:01:18', '2022-11-21 11:43:19', '学java是一个好选择！', 'http://cdn.forevergtt.love/mysystem/medicine/a34abe48-e2b9-4905-9f14-104a6fa4e466');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1331, 4, '计算机网络安全问题和日常防范措施', '由于互联网络的开放性和通信协议的安全缺陷，以及在网络环境中数据信息存储和对其访问与处理的分布性特点，网上传输的数据信息很容易泄露和被破坏，网络受到的安全攻击非常严重，因此建立有效的网络安全防范体系就更为迫切。下面是为大家整理的计算机网络安全问题及日常防范措施，希望大家能够从中有所收获!
...
为了防止受到这种攻击的危害，用户在进行密码设置时一定要将其设置得复杂，也可使用多种密码，或者变换思路使用中文密码。
', 93, 4, 0, '2023-05-06 14:01:18', '2022-12-08 10:59:33', '下面是为大家整理的计算机网络安全问题及日常防范措施，希望大家能够从中有所收获', 'http://cdn.forevergtt.love/mysystem/medicine/03b438d0-e359-4bc2-8cd1-a1194356fa18');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1332, 5, '12月编程语言排行榜：C++首次超越JAVA进入前三', 'IT之家 12 月 13 日消息，新的数据声称，C++ 是当今开发者使用的最流行的三大编程语言之一。
...
什么是成功的编程语言的定义在行业内是不同的，TIOBE 的指标只是衡量的一种方式。今年早些时候，CirlceCI 的 2022 年软件交付状况报告显示，最流行的编程语言前三名分别是 TypeScript、JavaScript 和 Ruby，Python 排在第四位，C 和 C++ 甚至没有进入前十名。', 10, 3, 0, '2023-05-06 14:01:18', '2022-12-09 05:56:18', 'CirlceCI 的 2022 年软件交付状况报告显示，最流行的编程语言前三名分别是 TypeScript、JavaScript 和 Ruby，Python 排在第四位，C 和 C++ 甚至没有进入前十名。', 'http://cdn.forevergtt.love/mysystem/medicine/8e876b21-99e8-4c93-b440-e5aad5e5377e');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1333, 2, '万字泣血解析割韭菜内幕，程序员别老想着做副业', '   
...
', 9, 0, 1, '2023-05-06 14:01:18', '2022-11-30 10:26:56', '万字泣血解析割韭菜内幕，程序员别老想着做副业', 'http://cdn.forevergtt.love/mysystem/medicine/be7a342b-8408-4c77-a9b3-c56ad86bf9ce');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1334, 6, '99%的Java程序员会踩的6个坑', '前言
...
', 10, 0, 1, '2023-05-06 14:01:18', '2022-11-16 16:33:26', '让你不再踩坑', 'http://cdn.forevergtt.love/mysystem/medicine/36706fcb-8de7-4fb6-91e3-c8f0a394216d');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1335, 7, '用vue构建用户界面有哪些好处？', '前端开发者最主要的工作，就是为网站的使用者(又称为：网站的用户)构建出美观、舒适、好用的网页。vue的出现，逐渐替代了传统的jQuery + 模板引擎构建页面方式，逐渐成为在构建用户界面方面的主流开发框架。下面就来看一下与vue框架传统开发框架相比有哪些优缺点。
...
基于vue中提供的事件绑定，可以轻松处理用户和页面之间的交互行为。开发者把工作的重心放在核心业务的实现上。', 2, 0, 1, '2023-05-06 14:01:18', '2022-12-02 16:37:20', '用vue构建用户界面有哪些好处？', 'http://cdn.forevergtt.love/mysystem/medicine/a7e843f9-0572-4a94-b560-17d014271db2');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1336, 8, '这 11 种编程语言，还“活着”吗？', '编程语言发展至今，有的语言仍然炙手可热，而有的语言已经敲响了丧钟。看看如下这张编程语言的历史纪年表，你听说过的有多少种？
...
那么，问题来了，随着编程语言如此快速的发展，未来我们将何去何从？', 4, 1, 1, '2023-05-06 14:01:18', '2022-12-01 16:51:02', '你听过多少种编程语言？目前主流的 Java 、Python、JavaScript、C、C++ 等自然是耳熟能详，但更早之前的编程语言你了解吗？你知道它们还在吗？', 'http://cdn.forevergtt.love/mysystem/medicine/85f44be8-c522-4082-ba16-575e4ef3bf0d');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1337, 9, '人类能实现大脑编程吗？', '　　  11月26日上午，第四届世界科技与发展论坛在成都天府国际会议中心拉开帷幕。在当日下午举行的“NexTus可持续发展青年创新日”活动上，来自人工智能、大数据、区块链、生物医药等领域的20位青年创新者代表，围绕联合国可持续发展目标中的良好健康与福祉（SDG 3）、经济适用的清洁能源（SDG 7）、产业、创新和基础设施（SDG 9）、可持续城市和社区（SDG 11）、促进目标实现的伙伴关系（SDG 17），设置具体主题进行了创新成果的分享和科学探讨。
...
　　  未来将如何突破脑机交互神经调控技术？耿馨佚认为，目前这项技术最前沿的就是它的交互性，既能读脑又能写脑，但是其突破有三大难点。首先是设备，必须有足够先进的硬件软件把信号收集起来和输入进去；其次就是算法，目前耿馨佚所在的研究机构正在利用数字孪生大脑去生成一些仿真的数据、算法；此外，还有临床实验面临的案例选择、实验成本等多重挑战.', 10020, 1, 2, '2023-05-06 14:01:18', '2022-12-03 16:54:59', '你听说过大脑编程吗', 'http://cdn.forevergtt.love/mysystem/medicine/6ebab6fa-aac9-4af9-a910-9e3e6ad40f38');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1338, 10, 'MySQL 中删除的数据流落何方?', '不知道大家有没有想过下面这件事？
...
很明显，它不是看当时的心情来决定取多少条的。它是通过配置项 innodb\\_purge\\_batch\\_size 来控制的，默认是300。然后InnoDB会将这300条 Undo Log 分给innodb\\_purge\\_threads个 Purge 线程。在清理的过程中，Purge 线程还会释放 Undo Log 表空间内的文件。', 0, 0, 0, '2023-05-06 14:01:18', '2022-11-18 19:11:04', '我们平时调用 DELETE 在 MySQL 中删除的数据都去哪儿了？', 'http://cdn.forevergtt.love/mysystem/medicine/da043411-6dc9-4c34-8608-43f2d5114c96');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1339, 11, 'HTML、CSS、JavaScript、PHP、 MySQL 的学习顺序是什么？', '在我看来，学习这些知识并没有固定的顺序，因为这几个知识的作用是不同的。
...
总结：这个行业就是只要学不死，就往死里学，没有最卷，只有更卷，所以如果只是自己搞一个网站玩一玩的话，就只需要学习HTML、CSS和Jquery框架就够用了。但是如果作为一个程序员的话，那就没得选择了，工作过程中遇到需要的技术栈、或者将来再出现新的技术栈，都需要不断的去学习。', 2, 0, 0, '2023-05-06 14:01:18', '2022-12-03 19:14:50', 'HTML、CSS、JavaScript、PHP、 MySQL 的学习顺序是什么？', 'http://cdn.forevergtt.love/mysystem/medicine/a742efd5-413b-42f3-8774-ff2e6735253a');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1340, 12, 'mysql数据库乱码如何解决？', '
...
上面给大家介绍了三种解决mysql乱码的方法，因为我们将来开发的系统，基本上都会涉及到非英文的数据，因此建议大家使用第一种方式，把数据库服务器的默认编码方式改成utf8,这样以后不管什么时候使用，都不会发生乱码问题！', 0, 0, 0, '2023-05-06 14:01:18', '2022-12-01 19:20:51', '作为一个数据库的初学者，遇到数据库乱码问题，是一个比较头疼的问题，下面根据我的使用经验，给大家分享几种解决mysql数据库乱码问题的方式，希望对大家有帮助。', 'http://cdn.forevergtt.love/mysystem/medicine/e8fe410c-7164-4fab-8998-0acd358f9337');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1341, 13, '对话MySQL之父：代码一次性完成才是优秀程序员', '
...
![](//n.sinaimg.cn/sinakd20220415ac/94/w1080h614/20220415/6006-b5e64063930f0b7ce9c0b5da8d9b69f9.jpg)', 5, 0, 0, '2023-05-06 14:01:18', '2022-06-14 19:25:19', 'MySQL之父Monty有着四十多年的编程经验，从儿时的兴趣到长大后的深耕，他在编程领域不断钻研，最终成为编程大师。', null);
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1342, 14, 'GitHub 多次宕机的罪魁祸首竟是 MySQL？', '![](//n.sinaimg.cn/sinakd20220328s/145/w107h38/20220328/a13a-194c1830f0e6f714abfb1afa3f89c051.png)
...
参考：https://github.blog/2022-03-23-an-update-on-recent-service-disruptions/', 0, 0, 0, '2023-05-06 14:01:18', '2022-11-11 19:28:02', '宕机时时有，但近期特别多。这边苹果服务器发生大规模宕机，导致 App Store、Apple Music、Books 等十几项服务中断，另一边全球知名代码托管平台 GitHub 也出现了此种情况。', null);
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1343, 15, 'JSP的九大内置对象是什么？JSP作用是什么？', '（1）问题分析：
...
其他举例Demo：https://download.csdn.net/download/a\\_blackmoon/10940085', 2, 1, 0, '2023-05-06 14:01:18', '2022-11-24 19:32:53', '下面带你了解JSP', null);
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1344, 16, '软件测试工程师的未来发展道路有哪些？', '　　很多想从事测试工作的学员，都想知道测试工作未来的发展方向。由于做测试要懂得很多技能和知识，所以测试发展的方向选择面应该是非常广的。本篇就讲一下测试职业的转型及未来发展方向。
...
', 3, 0, 0, '2023-05-06 14:01:18', '2022-11-18 19:39:37', '　很多想从事测试工作的学员，都想知道测试工作未来的发展方向。由于做测试要懂得很多技能和知识，所以测试发展的方向选择面应该是非常广的。本篇就讲一下测试职业的转型及未来发展方向。', null);
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1345, 17, '清华大学成立元宇宙实验室！网友怒批：欠考虑', '当菜场买菜的大妈和公园跳广场舞的大爷讨论“元宇宙是个啥玩意？”的时候，元宇宙已经成为了“抢手货”。但凡和元宇宙沾边，一经推出便会立即引起追捧。
...
在人才需求TOP职业中，研发岗和设计岗势均力敌，仍是元宇宙的主力军。可以这么说，程序员和设计人员作为元宇宙的基建人员，是距离元宇宙风口最近的一群人。', 2, 0, 1, '2023-05-06 14:01:18', '2022-10-20 19:53:51', '“元宇宙是个啥玩意？”', null);
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1346, 18, '12年的祖传“屎山”代码，年收入竟超1.4亿元？', '大家好，讲道理，许多做过代码届“接盘侠”的程序员们，某种程度上可能十分理解电影中执着于毁灭世界的反派：“与其在现有基础上修改，还不如直接把这堆祖传代码毁灭再重建！”
...
那么，你是否在工作中遇见过令人发指的“祖传代码”，最长拥有多少年历史？你是选择逐一改动还是放任不管？', 1, 0, 0, '2023-05-06 14:01:18', '2022-12-08 19:56:09', '祖传代码，从字面意思来看，就是一代代老程序员们留下来的“宝藏”代码——这些长年累月的代码中存有很多隐患，后来的“接盘侠”们要么无从下手，要么一改就崩，几乎可以说是程序员们的“终极噩梦”，因此也被称作“屎山代码”。', 'http://cdn.forevergtt.love/mysystem/medicine/a742efd5-413b-42f3-8774-ff2e6735253a');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1348, 20, '前端教程：开发流程中项目需求分析怎么做？', '
1.数据模型分析
...
(11)router.js：路由模块，根据用户的请求判断路径，然后将请求分发到具体的处理函数。', 0, 0, 0, '2023-05-06 14:01:18', '2022-11-25 20:03:50', '项目从开始到上线的流程中，当涉及代码部分时，最重要的环节是该项目的需求分析。编程人员只有明确需求才能够设计数据、逻辑层代码等。下面将针对项目中的需求分析进行详细介绍。', 'http://cdn.forevergtt.love/mysystem/medicine/82b75897-1137-4e5b-bb73-1d8d453c91f1');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1349, 21, '程序员如何不着痕迹伪装自己的菜鸟气质', '对于刚入行的程序员来说，面对各种各样的陌生配置环境和代码库，难免会手忙脚乱，尽显菜鸟本色。
...
除了一些有格调的书籍，数码设备方面也需要“见贤思齐”，作为一名高端的程序员，一定要少用鼠标，一直用鼠标点点点，就直接破功了。', 5, 0, 2, '2023-05-06 14:01:18', '2022-11-19 20:07:06', '菜鸟程序员该如何伪装自己，才能不让别人看出来自己菜？', null);
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1350, null, '大白话带你认识 JVM11', '1.  [Java 面试指南](/)
2.  [大白话带你认识 JVM](/java/jvm/jvm-intro.html)

大白话带你认识 JVM
===========

[Guide](https://javaguide.cn/article/)

*   Java

*   JVM

2021年11月9日约 9636 字大约 32 分钟

* * *

此页内容

*   [前言](/java/jvm/jvm-intro.html#前言)
*   [一、JVM 的基本介绍](/java/jvm/jvm-intro.html#一、jvm-的基本介绍)

*   [1.1 Java 文件是如何被运行的](/java/jvm/jvm-intro.html#_1-1-java-文件是如何被运行的)
*   [1.2 简单的代码例子](/java/jvm/jvm-intro.html#_1-2-简单的代码例子)

*   [二、类加载器的介绍](/java/jvm/jvm-intro.html#二、类加载器的介绍)

*   [2.1 类加载器的流程](/java/jvm/jvm-intro.html#_2-1-类加载器的流程)
*   [2.2 类加载器的加载顺序](/java/jvm/jvm-intro.html#_2-2-类加载器的加载顺序)
*   [2.3 双亲委派机制](/java/jvm/jvm-intro.html#_2-3-双亲委派机制)

*   [三、运行时数据区](/java/jvm/jvm-intro.html#三、运行时数据区)

*   [3.1 本地方法栈和程序计数器](/java/jvm/jvm-intro.html#_3-1-本地方法栈和程序计数器)
*   [3.2 方法区](/java/jvm/jvm-intro.html#_3-2-方法区)
*   [3.3 虚拟机栈和虚拟机堆](/java/jvm/jvm-intro.html#_3-3-虚拟机栈和虚拟机堆)
*   [3.4 垃圾回收算法](/java/jvm/jvm-intro.html#_3-4-垃圾回收算法)
*   [3.5 （了解）各种各样的垃圾回收器](/java/jvm/jvm-intro.html#_3-5-了解-各种各样的垃圾回收器)
*   [3.6 （了解）JVM 的常用参数](/java/jvm/jvm-intro.html#_3-6-了解-jvm-的常用参数)

*   [四、关于 JVM 调优的一些方面](/java/jvm/jvm-intro.html#四、关于-jvm-调优的一些方面)

*   [4.1 调整最大堆内存和最小堆内存](/java/jvm/jvm-intro.html#_4-1-调整最大堆内存和最小堆内存)
*   [4.2 调整新生代和老年代的比值](/java/jvm/jvm-intro.html#_4-2-调整新生代和老年代的比值)
*   [4.3 调整 Survivor 区和 Eden 区的比值](/java/jvm/jvm-intro.html#_4-3-调整-survivor-区和-eden-区的比值)
*   [4.4 设置年轻代和老年代的大小](/java/jvm/jvm-intro.html#_4-4-设置年轻代和老年代的大小)
*   [4.5 小总结](/java/jvm/jvm-intro.html#_4-5-小总结)
*   [4.6 永久区的设置](/java/jvm/jvm-intro.html#_4-6-永久区的设置)
*   [4.7 JVM 的栈参数调优](/java/jvm/jvm-intro.html#_4-7-jvm-的栈参数调优)
*   [4.8 (可以直接跳过了)JVM 其他参数介绍](/java/jvm/jvm-intro.html#_4-8-可以直接跳过了-jvm-其他参数介绍)

*   [finally](/java/jvm/jvm-intro.html#finally)

> 来自[说出你的愿望吧丷open in new window](https://juejin.im/user/5c2400afe51d45451758aa96)投稿，原文地址：https://juejin.im/post/5e1505d0f265da5d5d744050 。
...
### [#](#_1-1-java-文件是如何被运行的) 1.1 Java 文件是如何被运行的
...
### [#](#_3-1-本地方法栈和程序计数器) 3.1 本地方法栈和程序计数器
...
### [#](#_3-3-虚拟机栈和虚拟机堆) 3.3 虚拟机栈和虚拟机堆

一句话便是：栈管运行，堆管存储。则虚拟机栈负责运行代码，而虚拟机堆负责存储数据。

#### [#](#_3-3-1-虚拟机栈的概念) 3.3.1 虚拟机栈的概念
...
#### [#](#_3-3-7-eden-年轻代的介绍) 3.3.7 Eden 年轻代的介绍
...
#### [#](#_3-3-8-如何判断一个对象需要被干掉) 3.3.8 如何判断一个对象需要被干掉
...
#### [#](#_3-3-9-如何宣告一个对象的真正死亡) 3.3.9 如何宣告一个对象的真正死亡
...
### [#](#_3-4-垃圾回收算法) 3.4 垃圾回收算法

不会非常详细的展开，常用的有标记清除，复制，标记整理和分代收集算法

#### [#](#_3-4-1-标记清除算法) 3.4.1 标记清除算法
...
### [#](#_3-5-了解-各种各样的垃圾回收器) 3.5 （了解）各种各样的垃圾回收器
...
### [#](#_3-6-了解-jvm-的常用参数) 3.6 （了解）JVM 的常用参数
...
注意：此处的大小是（eden+ 2 survivor space).与 jmap -heap 中显示的 New gen 是不同的。整个堆大小=年轻代大小 + 老年代大小 + 持久代（永久代）大小.增大年轻代后,将会减小年老代大小.此值对系统性能影响较大,Sun 官方推荐配置为整个堆的 3/8
...
单位字节 新生代采用 Parallel ScavengeGC 时无效另一种直接在旧生代分配的情况是大的数组对象,且数组中无外部引用对象.
...
[#](#四、关于-jvm-调优的一些方面) 四、关于 JVM 调优的一些方面
---------------------------------------
...
### [#](#_4-1-调整最大堆内存和最小堆内存) 4.1 调整最大堆内存和最小堆内存
...
### [#](#_4-8-可以直接跳过了-jvm-其他参数介绍) 4.8 (可以直接跳过了)JVM 其他参数介绍

形形色色的参数很多，就不会说把所有都扯个遍了，因为大家其实也不会说一定要去深究到底。

#### [#](#_4-8-1-设置内存页的大小) 4.8.1 设置内存页的大小

    -XXThreadStackSize：
        设置内存页的大小，不可设置过大，会影响Perm的大小
    

#### [#](#_4-8-2-设置原始类型的快速优化) 4.8.2 设置原始类型的快速优化

    -XX:+UseFastAccessorMethods：
        设置原始类型的快速优化
    

#### [#](#_4-8-3-设置关闭手动-gc) 4.8.3 设置关闭手动 GC

    -XX:+DisableExplicitGC：
        设置关闭System.gc()(这个参数需要严格的测试)
    

#### [#](#_4-8-4-设置垃圾最大年龄) 4.8.4 设置垃圾最大年龄
...
#### [#](#_4-8-6-改善锁机制性能) 4.8.6 改善锁机制性能

    -XX:+UseBiasedLocking
    

#### [#](#_4-8-7-禁用垃圾回收) 4.8.7 禁用垃圾回收

    -Xnoclassgc
    

#### [#](#_4-8-8-设置堆空间存活时间) 4.8.8 设置堆空间存活时间

    -XX:SoftRefLRUPolicyMSPerMB
        设置每兆堆空闲空间中SoftReference的存活时间，默认值是1s。
    

#### [#](#_4-8-9-设置对象直接分配在老年代) 4.8.9 设置对象直接分配在老年代

    -XX:PretenureSizeThreshold
        设置对象超过多大时直接在老年代分配，默认值是0。
    

#### [#](#_4-8-10-设置-tlab-占-eden-区的比例) 4.8.10 设置 TLAB 占 eden 区的比例

    -XX:TLABWasteTargetPercent
        设置TLAB占eden区的百分比，默认值是1% 。
    

#### [#](#_4-8-11-设置是否优先-ygc) 4.8.11 设置是否优先 YGC
...
[编辑此页open in new window](https://github.com/Snailclimb/JavaGuide/edit/main/docs/java/jvm/jvm-intro.md)

上次编辑于: 2023/2/13 18:18:26

贡献者: guide,Guide,Konjacor,fjut\\_shark,yueyang
...
](/java/jvm/jvm-parameters-intro.html)[

下一页

JDK 监控和故障处理工具总结

](/java/jvm/jdk-monitoring-and-troubleshooting-tools.html)', 0, 0, 0, '2023-05-06 14:01:18', '2023-03-20 14:04:32', '大白话带你认识 JVM11', 'http://cdn.forevergtt.love/mysystem/medicine/5da055a8-1e8c-4216-a853-e785e0d4134b');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1351, null, '112c s', 'hellod', 0, 0, 0, '2023-05-06 14:01:18', '2023-03-20 14:30:51', '12', 'http://cdn.forevergtt.love/mysystem/medicine/4f1c6977-4128-4c72-ad88-6570bdba1876');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1352, null, '12we', 'hellosd', 3, 0, 0, '2023-05-06 14:01:18', '2023-03-20 14:46:37', '23', 'http://cdn.forevergtt.love/mysystem/medicine/e8fe410c-7164-4fab-8998-0acd358f9337');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1353, null, 'sdcsd', 'hellosd', 1, 0, 0, '2023-05-06 14:01:18', '2023-03-20 14:50:31', 'csdcs', 'http://cdn.forevergtt.love/mysystem/medicine/8aafb27a-3049-421b-a041-8ace5e5bb895');
INSERT INTO yyy.article (article_id, article_user_id, article_title, article_content, article_view_count, article_comment_count, article_dianzan_count, article_update_time, article_create_time, article_summary, article_th_img) VALUES (1354, null, 'df', 'hellodfv', 1, 0, 0, '2023-05-06 14:01:18', '2023-03-21 05:48:36', 'df', 'http://cdn.forevergtt.love/mysystem/medicine/99d3323f-120f-4973-8756-29290de5ffb0');
